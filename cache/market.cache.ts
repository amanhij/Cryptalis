...
import { MARKET_STATE_LAYOUT_V3, Token } from '@raydium-io/raydium-sdk';
...
export class MarketCache {
  ...
  async init(config: { quoteToken: Token }) {
    ...
    const accounts = await this.connection.getProgramAccounts(RAYDIUM_PROGRAM_ID.OPENBOOK_MARKET, {
