...
- `BURNED_PERCENTAGE_THRESHOLD` - Min percentage of LP tokens burned 0-100. 0 means no burn, 100 means all LP tokens are burned.
...
- If you want to leave a tip, you can send it to the following address:
  `EutnawM8opjrwaZgaaXLyHnez8fapXJetckdGFnppFJu`
